...
> ***AI정보공학과*** 를 전공하며 백엔드 개발자 역량을 길렀고
> <br />
...
> 
>> 프로젝트 상세 설명(Back-end)
>> 1. 얼굴 인식의 정면성을 해결하고 사용자가 측면이나 다양한 각도에서 얼굴을 제시하더라도 정확하게 인식할 수 있는 얼굴 인식 시스템을 제안하기 위해 시작
...
>> 5. 프론트엔드와 백엔드 연동을 통해 AI 모델과 실시간 서비스 기능을 통합하는 역할을 담당했습니다.
>
