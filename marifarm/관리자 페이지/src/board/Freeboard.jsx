...
function FreeBoard() {
  ...
  // 게시판 목록 가져오기
 const fetchBoardList = async (boardId, keyword = "") => {
  try {
    ...
    console.log("fetch url:", url); // 실제 호출되는 URL 확인용
  ...
  useEffect(() => {
    fetchBoardList(1,searchKeyword);
  }, []);
 ...
 const handleSearchSubmit = (e) => {
    e.preventDefault();
    fetchBoardList(1, searchKeyword); // 항상 1번 게시판에서 검색
  };
  // 폼 제출
  const handleFormSubmit = async (e) => {
    e.preventDefault();
    fetchBoardList(1, searchKeyword); // 1번 게시판에서 검색
  ...
  return (
    <div className="container-fluid">
      <h1 className="h3 mb-4 text-gray-800">게시판 관리</h1>
